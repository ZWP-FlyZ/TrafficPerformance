    ...
    <el-row>
        <el-col  class="chart-container" >
            <div class="chart-header" >
                <el-input placeholder="请输入市名/企业经营许可证号/船舶号" v-model="inputCode" style="width:450px" >
...
export default {
    ...
    methods:{
        ...
        getData(){
            ...
            if(this.inputCode==''){
                this.$confirm('未输入监测项（城市/企业/船舶）名称，默认查询浙江省全部地区的实时能耗数据，是否继续？','提示', {
